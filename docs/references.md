...
| Samtec | `SSQ-113-01-G-D` | Selected Nano P1/P2 stack sockets | 2 × 13, 2.54 mm pitch and row spacing, 8.51 mm body, 2.64 mm tails, 3.68–6.35 mm insertion range for 0.64 mm-square posts. Bottom-mounted on the daughterboard; nominal facing-PCB separation is 11.01 mm because USB-A/RJ45 are cleared by local cutouts. | [Exact product](https://www.samtec.com/products/ssq-113-01-g-d), [manufacturer SSQ drawing Rev. BH](https://suddendocs.samtec.com/prints/ssq-1xx-xx-xxx-x-xx-xxx-xx-x-mkt.pdf), [SSQ family](https://www.samtec.com/products/ssq) |
