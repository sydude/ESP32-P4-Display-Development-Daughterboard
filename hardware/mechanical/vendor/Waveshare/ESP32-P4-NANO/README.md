...
The Nano technical drawing on the KiCad PCB `User.1` layer is an edited/rescaled derivative created for visual layout work. It is not an untouched DXF import and is not an authoritative placement datum. Its validation and known conversion artifacts are recorded in `docs/design-notes/mechanical-interface-verification.md`. The exact P1/P2 `F.Fab` datums were subsequently cross-checked against these originals and are recorded in `docs/design-notes/preliminary-placement-mechanical-baseline.md`.

The Nano pinout chart and actual board image were both taken directly from the official Waveshare Nano wiki at:

<https://www.waveshare.com/wiki/ESP32-P4-Nano-StartPage?srsltid=AU7gw4Vd7bkizIuJfJvJKmm_JROOH3t23xUPwddF9wJ-HPnjU6yKf0q6#Hardware_Description>
